...
public class MemberController {
	...
	private UserService userService; 
	  ...
	  @RequestMapping(value = "/loginaction", method = RequestMethod.POST)
	    ...
	    {
		  long user = userService.authenticate(emailId, pwd);
		  if (user == ErrorCodes.NONNUMERIC_ID.value) { 
			  map.addAttribute("error", "Please Enter Numeric ID");
			  return "login";
		  }else if (user == ErrorCodes.INVALID_ID.value) { 
			  map.addAttribute("error", "User does not exists");
			  return "login";
		  }else if(user == ErrorCodes.INVALID_PASSWORD.value) {
